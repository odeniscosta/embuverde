  ...
  function renderBanner() {
    ...
    banner.innerHTML = `
      <div>
        ...
        <p>Usamos cookies opcionais para medir a navegação e melhorar este site. Você pode aceitar ou recusar. <a href="${privacyUrl}">Saiba mais</a>.</p>
      </div>
      <div class="consent-actions">
        <button type="button" class="consent-reject">Recusar</button>
